...
with st.sidebar:
    ...
    with col1:
        st.markdown(
            """
            <div style="background-color:#87CEEB; width:80px; height:80px; border-radius:50%; display:flex; align-items:center; justify-content:center; margin: 0 auto;">
                <span style="font-size:36px; color:white; font-weight:bold;">NP</span>
            </div>
            """, 
            unsafe_allow_html=True
        )
